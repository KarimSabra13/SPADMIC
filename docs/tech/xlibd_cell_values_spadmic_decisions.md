...
The extracted `DFRRQHDX2` recovery, removal, and reset min-pulse constraints are real Liberty checks. Waive only with protocol proof, for example if oscillators are stopped during clear/release and the waiver is tied to that behavior.
...
## Future XLIBD Requests

Priority cells for future detailed timing interpretation:

- `DFRRQHDX1`, `DFRQHDX2`, `DFRHDX1`, `DFRSHDX1`
- `BUHDX2`, `BUHDX3`, `INHDX0`, `INHDX1`, `INHDX2`
- `ON22HDX0`, `ON22HDX1`, `EO2HDX0`
- Optional: `BUHDX16`, clock buffers/inverters, integrated clock-gating cells
