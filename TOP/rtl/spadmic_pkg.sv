...
package spadmic_pkg;
  ...
  // Active matrix-top ABI aliases. New RTL should import spadmic_csr_map_pkg
  // directly; these names keep independently tested clients source-compatible.
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_GLOBAL_ID      = CSR_CHIP_ID;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_GLOBAL_VERSION = CSR_ABI_VERSION;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_GLOBAL_CTRL    = CSR_GLOBAL_CTRL;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_GLOBAL_STATUS  = CSR_GLOBAL_STATUS;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_GLOBAL_FAULT   = CSR_GLOBAL_FAULT;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_GLOBAL_FAULT_COUNT = CSR_ACCESS_ERROR_COUNT;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MTOP_CTRL_REQUEST = CSR_GLOBAL_CTRL;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MTOP_CTRL_ACTIVE  = CSR_GLOBAL_STATUS;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MTOP_STATUS       = CSR_GLOBAL_STATUS;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MTOP_FAULT        = CSR_ACCESS_FAULT;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MTOP_FAULT_COUNT  = CSR_ACCESS_ERROR_COUNT;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_SHARED_TDC_MAX_HITS = CSR_TDC_SHARED_CFG;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_SHARED_TDC_RO_SLOW  = CSR_TDC_SHARED_CFG;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_SHARED_TDC_RO_FAST  = CSR_TDC_SHARED_CFG;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_SHARED_TDC_CTRL     = CSR_TDC_SHARED_CMD;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_CALIB_AXIS_MASK     = CSR_CALIB_AXIS_MASK;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_PLL_CTRL            = CSR_PLL_CTRL;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_PLL_STATUS          = CSR_PLL_STATUS;

  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_POSITION_MODE       = CSR_POSITION_CFG;
  ...
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MATRIX_EVENT_STATUS = CSR_EVENT_STATUS;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MATRIX_SNAPSHOT_CFG = CSR_SNAPSHOT_CFG;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MATRIX_RESET_CTRL   = CSR_RESET_CFG;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MATRIX_RESET_STATUS = CSR_SNAPSHOT_RESET_STATUS;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MATRIX_R_SNAP_LO    = CSR_SNAPSHOT_R_LO;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MATRIX_R_SNAP_HI    = CSR_SNAPSHOT_R_HI;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MATRIX_Y_SNAP_LO    = CSR_SNAPSHOT_Y_LO;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MATRIX_Y_SNAP_HI    = CSR_SNAPSHOT_Y_HI;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MATRIX_B_SNAP_LO    = CSR_SNAPSHOT_B_LO;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MATRIX_B_SNAP_HI    = CSR_SNAPSHOT_B_HI;

  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MATRIX_CFG_CMD      = CSR_MATRIX_CMD;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MATRIX_CFG_STATUS   = CSR_MATRIX_STATUS;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MATRIX_CFG_COL      = CSR_MATRIX_COLUMN;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MATRIX_CFG_WDATA_LO = CSR_MATRIX_WDATA_LO;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MATRIX_CFG_WDATA_HI = CSR_MATRIX_WDATA_HI;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MATRIX_CFG_RDATA_LO = CSR_MATRIX_RDATA_LO;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MATRIX_CFG_RDATA_HI = CSR_MATRIX_RDATA_HI;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_MATRIX_CFG_LAST_ERROR = CSR_MATRIX_FAULT;

  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_OUTPUT_FIFO_STATUS = CSR_TX_FIFO_STATUS;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_OUTPUT_FIFO_WATERMARKS = CSR_TX_FIFO_GEOMETRY;
  localparam logic [SPADMIC_CSR_ADDR_W-1:0] SPADMIC_CSR_SLVS_GPIO_CTRL = CSR_SLVS_CTRL;
