...

{
  ...
  echo "LAYOUT_NORMALIZED_WIDTH_UM=${SPADMIC_LAYOUT_NORMALIZED_WIDTH_UM:-3200.0}"
  echo "LAYOUT_NORMALIZED_HEIGHT_UM=${SPADMIC_LAYOUT_NORMALIZED_HEIGHT_UM:-3700.0}"
...
python3 "$PNR_ROOT/scripts/gen_matrix_top_floorplan_plan.py" \
  ...
  --layout-normalized-width-um "${SPADMIC_LAYOUT_NORMALIZED_WIDTH_UM:-3200.0}" \
  --layout-normalized-height-um "${SPADMIC_LAYOUT_NORMALIZED_HEIGHT_UM:-3700.0}" \
