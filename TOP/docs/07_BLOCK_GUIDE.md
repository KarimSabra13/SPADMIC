...
| `spadmic_axis_cluster_scan` | `../position/rtl/spadmic_axis_cluster_scan.sv` | two-cycle registered `clk_sys` datapath | active | derive up to two clusters and overflow metadata from one axis snapshot |
