...
class spadmic_spad_reset_txn extends spadmic_base_txn;
  ...
  int unsigned     expected_width_cycles;
  ...
  function new();
    ...
    this.expected_width_cycles = 0;
    this.start_time_ps      = 0;
    this.end_time_ps        = 0;
  endfunction

  function string to_string();
    return $sformatf("[SPAD_RESET #%0d] width=%0d expected=%0d cycles start=%0t end=%0t",
                     txn_id, pulse_width_cycles, expected_width_cycles,
