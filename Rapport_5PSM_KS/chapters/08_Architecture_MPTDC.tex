...
\begin{figure}[H]
    ...
    \caption{Vue simplifiée de l'environnement de vérification. Les scénarios dirigés ou contraints aléatoires sont appliqués au DUT par les drivers ; les monitors reconstruisent les transactions observées, puis le scoreboard les compare au modèle de référence.}
