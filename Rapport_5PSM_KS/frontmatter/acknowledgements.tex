...
Ils vont d’abord à M.~Édouard Bechetoille, pour la qualité de son encadrement, sa disponibilité et la confiance accordée tout au long de cette période. Les échanges techniques menés autour de la mesure temporelle, de l’architecture numérique et des contraintes d’intégration ont constitué un appui déterminant dans la progression de ce travail.
...
Enfin, mes remerciements s’adressent à M.~Abdelbassat Massouri, tuteur académique, ainsi qu’à l’ensemble des enseignants de la formation PSM et à la direction de \textbf{CPE Lyon}. Leur disponibilité, la qualité du suivi pédagogique et l’exigence de la formation ont joué un rôle essentiel dans la conduite de cette alternance.
}
\clearpage
