# Genus Summary: `20260601_o3_raw_epoch_cleanup_genus`
...
Total TNS: `-1439587.6` ps, violating paths: `994`
Max fanout: `4858` on `clk_sys`

## Detailed Path Coverage

- Parsed detailed paths: `805`
- Detailed paths by group: `{'clk_osc_fast': 112, 'clk_osc_fast_tap7': 39, 'clk_osc_fast_tap6': 41, 'clk_osc_fast_tap4': 46, 'clk_osc_fast_tap1': 18, 'clk_sys': 549}`
- Detailed paths by bucket: `{'D_oscillator_pd_measurement': 256, 'A_real_clk_sys_setup': 549}`

## Latch/DRV/Intent

- Latch count: `7`
- DRV totals: `{'max_transition': 287264}`
