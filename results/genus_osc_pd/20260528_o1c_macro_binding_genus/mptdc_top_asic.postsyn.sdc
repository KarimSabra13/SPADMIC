...
#  Created by Genus(TM) Synthesis Solution 22.13-s093_1 on Thu May 28 16:53:09 CEST 2026
...
create_clock -name "clk_osc_slow" -period 1.0 -waveform {0.0 0.5} [get_pins {u_core_u_osc_slow_u_ro_tune4/S[0]}]
create_clock -name "clk_osc_slow_tap1" -period 1.0 -waveform {0.055 0.555} [get_pins {u_core_u_osc_slow_u_ro_tune4/S[1]}]
create_clock -name "clk_osc_slow_tap2" -period 1.0 -waveform {0.11 0.61} [get_pins {u_core_u_osc_slow_u_ro_tune4/S[2]}]
create_clock -name "clk_osc_slow_tap3" -period 1.0 -waveform {0.165 0.665} [get_pins {u_core_u_osc_slow_u_ro_tune4/S[3]}]
create_clock -name "clk_osc_slow_tap4" -period 1.0 -waveform {0.22 0.72} [get_pins {u_core_u_osc_slow_u_ro_tune4/S[4]}]
create_clock -name "clk_osc_slow_tap5" -period 1.0 -waveform {0.275 0.775} [get_pins {u_core_u_osc_slow_u_ro_tune4/S[5]}]
create_clock -name "clk_osc_slow_tap6" -period 1.0 -waveform {0.33 0.83} [get_pins {u_core_u_osc_slow_u_ro_tune4/S[6]}]
create_clock -name "clk_osc_slow_tap7" -period 1.0 -waveform {0.385 0.885} [get_pins {u_core_u_osc_slow_u_ro_tune4/S[7]}]
create_clock -name "clk_osc_fast" -period 0.9 -waveform {0.0 0.45} [get_pins {u_core_u_osc_fast_u_ro_tune4/S[0]}]
create_clock -name "clk_osc_fast_tap1" -period 0.9 -waveform {0.05 0.5} [get_pins {u_core_u_osc_fast_u_ro_tune4/S[1]}]
create_clock -name "clk_osc_fast_tap2" -period 0.9 -waveform {0.1 0.55} [get_pins {u_core_u_osc_fast_u_ro_tune4/S[2]}]
create_clock -name "clk_osc_fast_tap3" -period 0.9 -waveform {0.15 0.6} [get_pins {u_core_u_osc_fast_u_ro_tune4/S[3]}]
create_clock -name "clk_osc_fast_tap4" -period 0.9 -waveform {0.2 0.65} [get_pins {u_core_u_osc_fast_u_ro_tune4/S[4]}]
create_clock -name "clk_osc_fast_tap5" -period 0.9 -waveform {0.25 0.7} [get_pins {u_core_u_osc_fast_u_ro_tune4/S[5]}]
create_clock -name "clk_osc_fast_tap6" -period 0.9 -waveform {0.3 0.75} [get_pins {u_core_u_osc_fast_u_ro_tune4/S[6]}]
create_clock -name "clk_osc_fast_tap7" -period 0.9 -waveform {0.35 0.8} [get_pins {u_core_u_osc_fast_u_ro_tune4/S[7]}]
...
set_clock_groups -name "clock_groups_clk_sys_to_clk_osc_slow_clk_osc_slow_tap1_clk_osc_slow_tap2_clk_osc_slow_tap3_clk_osc_slow_tap4_clk_osc_slow_tap5_clk_osc_slow_tap6_clk_osc_slow_tap7_to_clk_osc_fast_clk_osc_fast_tap1_clk_osc_fast_tap2_clk_osc_fast_tap3_clk_osc_fast_tap4_clk_osc_fast_tap5_clk_osc_fast_tap6_clk_osc_fast_tap7" -asynchronous -group [get_clocks clk_sys] -group [list \
  ...
  [get_clocks clk_osc_fast_tap6]  \
  [get_clocks clk_osc_fast_tap7] ]
group_path -name O1C_PD_CAPTURE -to [list \
...
group_path -name O1C_REAL_FAST -to [list \
...
group_path -name O1C_REAL_SLOW -to [list \
...
group_path -name O1C_HELD_BUS_CDC -to [list \
