# Genus O4 Muxless Tags / R600 Summary

- Run ID: `20260602_o4_muxless_tags_r600_o4_r600_fast`
- Git HEAD: `6641ac94975e6bf37488576362e4e1bee0a0cf45`
- Timing mode: `r600_whatif`
- Genus effort: `fast`
- Genus exit code: 0
...
- SDC overlay: `/home/validmgr/ksabra/2026_SPAD/SPADMIC/MPTDC/syn/inputs/mptdc_osc_pd_o4.sdc`
- HDL filelist: `/home/validmgr/ksabra/2026_SPAD/SPADMIC/MPTDC/syn/filelist_o4_muxless_tags_r600.f`
- slow period ns: `1.667`
- fast period ns: `1.567`
- slow tap step ns: `0.1041875`
- fast tap step ns: `0.0979375`
- RO_tune4 instance count: 2
- mptdc_osc_stub residue count: 0
- fast-tag netlist reference count: 23
- old fast-counter residue count: 0
- slow Johnson epoch reference count: 2
- old slow-counter residue count: 0
- report_clocks RO_tune4/S match count: 16

O4_STATUS=O4_NETLIST_CANDIDATE
STATUS_LABEL=REAL_PHYSICAL_ABSTRACT_WITH_MUXLESS_RAW_TAGS
PD_BEHAVIOR_LOCKED=YES
RAW_LFSR_TAG_SOFTWARE_DECODE=YES
R600_ANALOG_CONFIRMED=NO
...
UNKNOWN_REVIEW_REQUIRED: WNS=-1332.0 TNS=-504775.0 count=444

## Key Files
- present: `genus_20260602_o4_muxless_tags_r600_o4_r600_fast.log`
- present: `mptdc_top_asic.postsyn.v`
- present: `o4_muxless_tags_r600_check.rpt`
...
- present: `o4_class_wns_summary.txt`
