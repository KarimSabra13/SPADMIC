...
#  Created by Genus(TM) Synthesis Solution 22.13-s093_1 on Tue Jun 02 11:02:49 CEST 2026
...
create_clock -name "clk_osc_slow" -period 1.667 -waveform {0.0 0.8335} [get_pins {u_core_u_osc_slow/u_ro_tune4/S[0]}]
create_clock -name "clk_osc_slow_tap1" -period 1.667 -waveform {0.10419 0.93769} [get_pins {u_core_u_osc_slow/u_ro_tune4/S[1]}]
create_clock -name "clk_osc_slow_tap2" -period 1.667 -waveform {0.20838 1.04188} [get_pins {u_core_u_osc_slow/u_ro_tune4/S[2]}]
create_clock -name "clk_osc_slow_tap3" -period 1.667 -waveform {0.31256 1.14606} [get_pins {u_core_u_osc_slow/u_ro_tune4/S[3]}]
create_clock -name "clk_osc_slow_tap4" -period 1.667 -waveform {0.41675 1.25025} [get_pins {u_core_u_osc_slow/u_ro_tune4/S[4]}]
create_clock -name "clk_osc_slow_tap5" -period 1.667 -waveform {0.52094 1.35444} [get_pins {u_core_u_osc_slow/u_ro_tune4/S[5]}]
create_clock -name "clk_osc_slow_tap6" -period 1.667 -waveform {0.62513 1.45863} [get_pins {u_core_u_osc_slow/u_ro_tune4/S[6]}]
create_clock -name "clk_osc_slow_tap7" -period 1.667 -waveform {0.72931 1.56281} [get_pins {u_core_u_osc_slow/u_ro_tune4/S[7]}]
create_clock -name "clk_osc_fast" -period 1.567 -waveform {0.0 0.7835} [get_pins {u_core_u_osc_fast/u_ro_tune4/S[0]}]
create_clock -name "clk_osc_fast_tap1" -period 1.567 -waveform {0.09794 0.88144} [get_pins {u_core_u_osc_fast/u_ro_tune4/S[1]}]
create_clock -name "clk_osc_fast_tap2" -period 1.567 -waveform {0.19588 0.97938} [get_pins {u_core_u_osc_fast/u_ro_tune4/S[2]}]
create_clock -name "clk_osc_fast_tap3" -period 1.567 -waveform {0.29381 1.07731} [get_pins {u_core_u_osc_fast/u_ro_tune4/S[3]}]
create_clock -name "clk_osc_fast_tap4" -period 1.567 -waveform {0.39175 1.17525} [get_pins {u_core_u_osc_fast/u_ro_tune4/S[4]}]
create_clock -name "clk_osc_fast_tap5" -period 1.567 -waveform {0.48969 1.27319} [get_pins {u_core_u_osc_fast/u_ro_tune4/S[5]}]
create_clock -name "clk_osc_fast_tap6" -period 1.567 -waveform {0.58763 1.37113} [get_pins {u_core_u_osc_fast/u_ro_tune4/S[6]}]
create_clock -name "clk_osc_fast_tap7" -period 1.567 -waveform {0.68556 1.46906} [get_pins {u_core_u_osc_fast/u_ro_tune4/S[7]}]
...
set_false_path -to [list \
  [get_pins {u_core_u_stop_capture/stop_slow_phase_disc_o_reg[2]/D}]  \
  [get_pins {u_core_u_stop_capture/stop_slow_phase_disc_o_reg[0]/D}]  \
  [get_pins {u_core_u_stop_capture/stop_slow_phase_disc_o_reg[1]/D}] ]
...
set_max_delay 1.567 -from [get_clocks clk_sys] -to [list \
