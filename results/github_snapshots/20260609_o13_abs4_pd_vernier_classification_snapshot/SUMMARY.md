...
- Run mode: `O13_ABS4_PD_VERNIER_CLASSIFICATION`
- Git HEAD: `010f285f87726d4df05480487ef1e66044c84a21`
- Genus exit code: 0
...
- PD intentional Vernier paths matched: 8
- PD intentional Vernier exception applied: NO
- PD intentional Vernier overmatch: YES
- UNKNOWN_REVIEW_REQUIRED count: 0
- SDC command failure count: 32

O13_STATUS=O13_ABS4_PD_VERNIER_CLASSIFICATION_REVIEW_CANDIDATE
FINAL_SIGNOFF=NO
INNOVUS_READY=NO_REVIEW_O13_ABS4_GENUS_FIRST

## Key Files
- present: `genus_20260609_o13_abs4_pd_vernier_classification.log`
