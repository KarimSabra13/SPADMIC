...
BUJIHDX4_PHASE_ISO_COUNT="$(first_nonempty "$(summary_value "BUJIHDX4 phase-buffer u_iso count")" "$(summary_value "u_iso text count")")"
BUJIHDX12_PHASE_DRV_COUNT="$(first_nonempty "$(summary_value "BUJIHDX12 phase-buffer u_drv count")" "$(summary_value "u_drv text count")")"
