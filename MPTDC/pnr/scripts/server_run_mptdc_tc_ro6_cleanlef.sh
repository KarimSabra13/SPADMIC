...
# Keep ordinary signal routing off METTP in the clean-LEF RO6 path.  The real
# RO_tune6 abstract contains METTP blockages at the phase/control pin access
# edge, so letting NanoRoute promote the signal top layer to METTP creates
# regular-signal shorts against the macro blockage.
export MPTDC_PNR_PROMOTE_SIGNAL_TOP_TO_EFFECTIVE_FLOOR="${MPTDC_PNR_PROMOTE_SIGNAL_TOP_TO_EFFECTIVE_FLOOR:-0}"
export MPTDC_PNR_ALLOW_SPECIAL_ROUTE_ABOVE_SIGNAL_TOP="${MPTDC_PNR_ALLOW_SPECIAL_ROUTE_ABOVE_SIGNAL_TOP:-1}"
export MPTDC_PNR_KEEP_ROUTER_TOP_AT_EFFECTIVE_FLOOR_FOR_EXISTING_ROUTES="${MPTDC_PNR_KEEP_ROUTER_TOP_AT_EFFECTIVE_FLOOR_FOR_EXISTING_ROUTES:-0}"
export MPTDC_PNR_PHASE_METTP_EXCEPTION="${MPTDC_PNR_PHASE_METTP_EXCEPTION:-0}"
export MPTDC_PNR_PHASE_TOP_LAYER="${MPTDC_PNR_PHASE_TOP_LAYER:-MET3}"
export MPTDC_PNR_PHASE_TOP_LAYER_IDX="${MPTDC_PNR_PHASE_TOP_LAYER_IDX:-3}"
