# =============================================================================
# O10 Innovus typical feasibility entrypoint
# =============================================================================
...
proc mptdc_o10_setup_globals {} {
    ...
    set o10(run_id) [mptdc_o10_env MPTDC_O10_RUN_ID 20260604_o10_typical_feasibility]
    ...
    set o10(sdc_overlay) [mptdc_o10_env MPTDC_O10_SDC_OVERLAY "$mptdc_root/syn/inputs/mptdc_osc_typical_r750_delta5.sdc"]
...
proc mptdc_o10_write_mmmc {} {
    ...
    set mmmc "$o10(work_dir)/o10_typical_only.mmmc"
    set fh [open $mmmc w]
...
proc mptdc_o10_verify_inputs {} {
    ...
    mptdc_o10_required_file "O9 R750 SDC overlay" $o10(sdc_overlay)
...
proc mptdc_o10_write_manifest {stage} {
    ...
    puts $fh "O9 overlay SDC: $o10(sdc_overlay)"
...
proc mptdc_o10_init_design {} {
    ...
    mptdc_o10_msg "Initializing design with typical-only O10 view"
    init_design
...
proc mptdc_o10_main {} {
    ...
    source "$o10(script_dir)/innovus_o10_screenshots.tcl"
    source "$o10(script_dir)/innovus_o10_reports.tcl"
    ...
    source "$o10(script_dir)/innovus_o10_cts.tcl"
    source "$o10(script_dir)/innovus_o10_route.tcl"
    source "$o10(script_dir)/innovus_o10_phase_net_reports.tcl"
    ...
    mptdc_o10_msg "O10 Innovus typical feasibility complete"
}
