# =============================================================================
# O10.2 Innovus typical feasibility entrypoint
# =============================================================================

proc mptdc_o10_msg {msg} {
    puts "MPTDC_O10_2: $msg"
}

proc mptdc_o10_fail {msg} {
    puts "MPTDC_O10_2_ERROR: $msg"
    exit 1
}
...
proc mptdc_o10_setup_globals {} {
    ...
    set o10(run_id) [mptdc_o10_env MPTDC_O10_RUN_ID 20260604_o10_2_pnr_repair]
    ...
    set o10(run_mode) [mptdc_o10_env MPTDC_O10_2_MODE route_feasibility]
    ...
    set design(postsyn_netlist) [mptdc_o10_repo_abs_path [mptdc_o10_env MPTDC_O10_NETLIST "$repo_root/results/genus_osc_pd/20260604_o9_final_typical_r750_delta5/mptdc_axis_core.postsyn.v"]]
    set design(postsyn_sdc) [mptdc_o10_repo_abs_path [mptdc_o10_env MPTDC_O10_POSTSYN_SDC "$repo_root/results/genus_osc_pd/20260604_o9_final_typical_r750_delta5/mptdc_axis_core.postsyn.sdc"]]
...
proc mptdc_o10_write_mmmc {} {
    ...
    set mmmc "$o10(work_dir)/o10_2_typical_only.mmmc"
    set fh [open $mmmc w]
...
proc mptdc_o10_write_manifest {stage} {
    ...
    set fh [open $path w]
    puts $fh "O10.2 Innovus manifest"
    puts $fh "======================"
    puts $fh "Generated: [clock format [clock seconds] -format {%Y-%m-%d %H:%M:%S %Z}]"
    puts $fh "Stage: $stage"
    ...
    puts $fh "O10.2 overlay SDC: $o10(sdc_overlay)"
...
proc mptdc_o10_init_design {} {
    ...
    mptdc_o10_msg "Initializing design with O10.2 typical-only repaired view"
    init_design
...
proc mptdc_o10_main {} {
    ...
    source "$o10(script_dir)/innovus_mptdc_physical_effort.tcl"
