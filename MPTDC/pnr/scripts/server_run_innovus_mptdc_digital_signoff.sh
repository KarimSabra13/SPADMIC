...
apply_recovery_defaults() {
  ...
  export MPTDC_ENABLE_BLOCK_PG_STITCH_STRIPES="${MPTDC_ENABLE_BLOCK_PG_STITCH_STRIPES:-1}"
  ...
  export MPTDC_ENABLE_POSTPLACE_SROUTE_CANDIDATE_PROBE="${MPTDC_ENABLE_POSTPLACE_SROUTE_CANDIDATE_PROBE:-1}"
