...
grep -qx 'REPAIR_METHOD=PREFERRED_LAYER_CONSTRAINED_ROUTE_DESIGN_SELECTED_V2' "$WORK/innovus/geometry_repair_clean/reports/operator_gate_route_geometry_repair.rpt"
