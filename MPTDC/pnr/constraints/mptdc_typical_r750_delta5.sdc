# Purpose: Stable Innovus alias for the MPTDC R750_delta5 typical base mode.
# Source mode: R750_delta5 typical-only.
# Signoff: not MMMC signoff, not final tapeout signoff.
# Related legacy file: mptdc_osc_typical_r750_delta5_innovus.sdc.
# Author: Karim Sabra

set mptdc_stable_sdc_self [file normalize [info script]]
set mptdc_stable_sdc_dir [file dirname $mptdc_stable_sdc_self]
set mptdc_stable_sdc_legacy [file join $mptdc_stable_sdc_dir mptdc_osc_typical_r750_delta5_innovus.sdc]
