...
export MPTDC_GENUS_CLOSURE_PROFILE="${MPTDC_GENUS_CLOSURE_PROFILE:-timing_ultra}"
...
# Default final product-axis closure uses the Repair8 JIHD exact fast-tag setup.
# Override MPTDC_GENUS_REPAIR8_JIHD_EXACT_FAST_TAG_CLOSE=0 only for archived
# pre-Repair8 comparisons.
...
if [[ "$MPTDC_GENUS_REPAIR8_JIHD_EXACT_FAST_TAG_CLOSE" == "1" ]]; then
  export MPTDC_STABLE_CLOSURE_LABEL="MPTDC_FINAL_TYPICAL_GENUS_REPAIR8_JIHD_EXACT_FAST_TAG_CLOSE"
...
echo "Closure profile: $MPTDC_GENUS_CLOSURE_PROFILE"
...
echo "Repair8 JIHD exact fast-tag close: $MPTDC_GENUS_REPAIR8_JIHD_EXACT_FAST_TAG_CLOSE"
...
echo "Exact fast-tag source-cell override disabled: ${MPTDC_FAST_TAG_REPAIR_EXACT_SOURCE_CELL_DISABLE:-0}"
...
echo "Exact fast-tag skip unsupported source cells: ${MPTDC_FAST_TAG_REPAIR_EXACT_SOURCE_SKIP_UNSUPPORTED:-0}"
