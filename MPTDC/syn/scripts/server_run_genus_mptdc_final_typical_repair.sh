...
export MPTDC_FAST_TAG_REPAIR_MAX_FANOUT="${MPTDC_FAST_TAG_REPAIR_MAX_FANOUT:-4}"
export MPTDC_FAST_TAG_REPAIR_MAX_TRANSITION_NS="${MPTDC_FAST_TAG_REPAIR_MAX_TRANSITION_NS:-0.35}"
export MPTDC_CONTROL_REPAIR_MAX_FANOUT="${MPTDC_CONTROL_REPAIR_MAX_FANOUT:-16}"
export MPTDC_CONTROL_REPAIR_MAX_TRANSITION_NS="${MPTDC_CONTROL_REPAIR_MAX_TRANSITION_NS:-0.45}"
