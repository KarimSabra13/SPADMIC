...

{
  ...
  echo "  MPTDC_PD_LOCAL_ON22_EXPECTED_CELLS=${MPTDC_PD_LOCAL_ON22_EXPECTED_CELLS:-448}"
...
if [[ "${MPTDC_GENUS_REPAIR_PD_LOCAL_ON22:-0}" == "1" ]]; then
  ...
  if [[ ( "$PD_LOCAL_ON22_REPAIR_ENABLE" == "1" || "$PD_LOCAL_ON22_REPAIR_ENABLE" == "true" ) \
      ...
      && "$PD_LOCAL_ON22_SOURCE_CELLS_FOUND" == "$PD_LOCAL_ON22_SOURCE_CELLS_EXPECTED" \
      && "$PD_LOCAL_ON22_TARGET_CELLS_FOUND" == "$PD_LOCAL_ON22_SOURCE_CELLS_EXPECTED" \
