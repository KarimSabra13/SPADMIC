...

{
  ...
  echo "  MPTDC_PD_LOCAL_ON22_EXPECTED_DRIVERS=${MPTDC_PD_LOCAL_ON22_EXPECTED_DRIVERS:-AUTO}"
  echo "  MPTDC_PD_LOCAL_ON22_EXPECTED_CELLS=${MPTDC_PD_LOCAL_ON22_EXPECTED_CELLS:-AUTO}"
  echo "  MPTDC_PD_LOCAL_ON22_DISCOVERY_MODE=${MPTDC_PD_LOCAL_ON22_DISCOVERY_MODE:-TIMING_REPORT}"
  echo "  MPTDC_PD_LOCAL_ON22_TIMING_MAX_PATHS=${MPTDC_PD_LOCAL_ON22_TIMING_MAX_PATHS:-1000}"
  echo "  MPTDC_PD_LOCAL_ON22_APPLY_REPAIR=${MPTDC_PD_LOCAL_ON22_APPLY_REPAIR:-1}"
  echo "  MPTDC_PD_LOCAL_ON22_ALLOW_X2=${MPTDC_PD_LOCAL_ON22_ALLOW_X2:-0}"
...
mirror_final_report_artifacts() {
  ...
  for file in \
    ...
    pd_local_on22_timing_discovery.rpt; do
...
PD_LOCAL_ON22_APPLY_REPAIR=NA
PD_LOCAL_ON22_SOURCE_CELL=NA
PD_LOCAL_ON22_ALLOW_X2=NA
PD_LOCAL_ON22_REQUESTED_TARGET_CELLS=NA
...
PD_LOCAL_ON22_TIMING_ON22_ROWS_FOUND=NA
PD_LOCAL_ON22_TIMING_ON22_LOCAL_ROWS_FOUND=NA
PD_LOCAL_ON22_TIMING_UNIQUE_ON22_INSTANCES_FOUND=NA
PD_LOCAL_ON22_TIMING_RESOLVED_ON22_INSTANCES_FOUND=NA
PD_LOCAL_ON22_SOURCE_DRIVERS_EXPECTED=NA
PD_LOCAL_ON22_SOURCE_DRIVERS_FOUND=NA
PD_LOCAL_ON22_SOURCE_CELLS_EXPECTED=NA
PD_LOCAL_ON22_SOURCE_CELLS_FOUND=NA
PD_LOCAL_ON22_UNRESOLVED_CELLS=NA
...
PD_LOCAL_ON22_DISCOVERY_MODE=NA
PD_LOCAL_ON22_TIMING_MAX_PATHS=NA
...
if [[ -f "$RESULT_DIR/pd_local_on22_repair_status.rpt" || -f "$RESULT_DIR/reports/pd_local_on22_repair_status.rpt" ]]; then
  ...
  PD_LOCAL_ON22_APPLY_REPAIR="$(pd_local_on22_value PD_LOCAL_ON22_APPLY_REPAIR)"
  PD_LOCAL_ON22_SOURCE_CELL="$(pd_local_on22_value PD_LOCAL_ON22_SOURCE_CELL)"
  PD_LOCAL_ON22_ALLOW_X2="$(pd_local_on22_value PD_LOCAL_ON22_ALLOW_X2)"
  PD_LOCAL_ON22_REQUESTED_TARGET_CELLS="$(pd_local_on22_value PD_LOCAL_ON22_REQUESTED_TARGET_CELLS)"
  ...
  PD_LOCAL_ON22_TIMING_ON22_ROWS_FOUND="$(pd_local_on22_value PD_LOCAL_ON22_TIMING_ON22_ROWS_FOUND)"
  PD_LOCAL_ON22_TIMING_ON22_LOCAL_ROWS_FOUND="$(pd_local_on22_value PD_LOCAL_ON22_TIMING_ON22_LOCAL_ROWS_FOUND)"
  PD_LOCAL_ON22_TIMING_UNIQUE_ON22_INSTANCES_FOUND="$(pd_local_on22_value PD_LOCAL_ON22_TIMING_UNIQUE_ON22_INSTANCES_FOUND)"
  PD_LOCAL_ON22_TIMING_RESOLVED_ON22_INSTANCES_FOUND="$(pd_local_on22_value PD_LOCAL_ON22_TIMING_RESOLVED_ON22_INSTANCES_FOUND)"
  PD_LOCAL_ON22_SOURCE_DRIVERS_EXPECTED="$(pd_local_on22_value PD_LOCAL_ON22_SOURCE_DRIVERS_EXPECTED)"
  ...
  PD_LOCAL_ON22_UNRESOLVED_CELLS="$(pd_local_on22_value PD_LOCAL_ON22_UNRESOLVED_CELLS)"
  ...
  PD_LOCAL_ON22_DISCOVERY_MODE="$(pd_local_on22_value PD_LOCAL_ON22_DISCOVERY_MODE)"
  PD_LOCAL_ON22_TIMING_MAX_PATHS="$(pd_local_on22_value PD_LOCAL_ON22_TIMING_MAX_PATHS)"
  PD_LOCAL_ON22_REPAIR_ENABLE="${PD_LOCAL_ON22_REPAIR_ENABLE:-NA}"
  PD_LOCAL_ON22_APPLY_REPAIR="${PD_LOCAL_ON22_APPLY_REPAIR:-NA}"
  PD_LOCAL_ON22_SOURCE_CELL="${PD_LOCAL_ON22_SOURCE_CELL:-NA}"
  PD_LOCAL_ON22_ALLOW_X2="${PD_LOCAL_ON22_ALLOW_X2:-NA}"
  PD_LOCAL_ON22_REQUESTED_TARGET_CELLS="${PD_LOCAL_ON22_REQUESTED_TARGET_CELLS:-NA}"
  ...
  PD_LOCAL_ON22_TIMING_ON22_ROWS_FOUND="${PD_LOCAL_ON22_TIMING_ON22_ROWS_FOUND:-NA}"
  PD_LOCAL_ON22_TIMING_ON22_LOCAL_ROWS_FOUND="${PD_LOCAL_ON22_TIMING_ON22_LOCAL_ROWS_FOUND:-NA}"
  PD_LOCAL_ON22_TIMING_UNIQUE_ON22_INSTANCES_FOUND="${PD_LOCAL_ON22_TIMING_UNIQUE_ON22_INSTANCES_FOUND:-NA}"
  PD_LOCAL_ON22_TIMING_RESOLVED_ON22_INSTANCES_FOUND="${PD_LOCAL_ON22_TIMING_RESOLVED_ON22_INSTANCES_FOUND:-NA}"
  PD_LOCAL_ON22_SOURCE_DRIVERS_EXPECTED="${PD_LOCAL_ON22_SOURCE_DRIVERS_EXPECTED:-NA}"
  ...
  PD_LOCAL_ON22_UNRESOLVED_CELLS="${PD_LOCAL_ON22_UNRESOLVED_CELLS:-NA}"
  ...
  PD_LOCAL_ON22_DISCOVERY_MODE="${PD_LOCAL_ON22_DISCOVERY_MODE:-NA}"
  PD_LOCAL_ON22_TIMING_MAX_PATHS="${PD_LOCAL_ON22_TIMING_MAX_PATHS:-NA}"
fi
...
write_final_readiness() {
  local out="$RESULT_DIR/final_typical_genus_readiness.md"
  {
    ...
    if [[ "${MPTDC_GENUS_REPAIR_PD_LOCAL_ON22:-0}" == "1" ]]; then
      ...
      emit_check_text "PD local ON22 apply repair" 1 "$PD_LOCAL_ON22_APPLY_REPAIR"
      emit_check "PD local ON22 endpoints" "$PD_LOCAL_ON22_ENDPOINTS_EXPECTED" "$PD_LOCAL_ON22_ENDPOINTS_FOUND"
      if [[ "$PD_LOCAL_ON22_TIMING_ON22_ROWS_FOUND" =~ ^[0-9]+$ && "$PD_LOCAL_ON22_TIMING_ON22_ROWS_FOUND" -gt 0 ]]; then
        echo "| PD local ON22 timing rows | \`POSITIVE\` | \`$PD_LOCAL_ON22_TIMING_ON22_ROWS_FOUND\` | PASS |"
      else
        echo "| PD local ON22 timing rows | \`POSITIVE\` | \`$PD_LOCAL_ON22_TIMING_ON22_ROWS_FOUND\` | FAIL |"
      fi
      if [[ "$PD_LOCAL_ON22_TIMING_ON22_LOCAL_ROWS_FOUND" =~ ^[0-9]+$ && "$PD_LOCAL_ON22_TIMING_ON22_LOCAL_ROWS_FOUND" -gt 0 ]]; then
        echo "| PD local ON22 timing local rows | \`POSITIVE\` | \`$PD_LOCAL_ON22_TIMING_ON22_LOCAL_ROWS_FOUND\` | PASS |"
      else
        echo "| PD local ON22 timing local rows | \`POSITIVE\` | \`$PD_LOCAL_ON22_TIMING_ON22_LOCAL_ROWS_FOUND\` | FAIL |"
      fi
      if [[ "$PD_LOCAL_ON22_TIMING_UNIQUE_ON22_INSTANCES_FOUND" =~ ^[0-9]+$ && "$PD_LOCAL_ON22_TIMING_UNIQUE_ON22_INSTANCES_FOUND" -gt 0 ]]; then
        echo "| PD local ON22 unique timing instances | \`POSITIVE\` | \`$PD_LOCAL_ON22_TIMING_UNIQUE_ON22_INSTANCES_FOUND\` | PASS |"
      else
        echo "| PD local ON22 unique timing instances | \`POSITIVE\` | \`$PD_LOCAL_ON22_TIMING_UNIQUE_ON22_INSTANCES_FOUND\` | FAIL |"
      fi
      emit_check "PD local ON22 unresolved cells" 0 "$PD_LOCAL_ON22_UNRESOLVED_CELLS"
      PD_LOCAL_ON22_EXPECTED_DRIVERS_UPPER="${PD_LOCAL_ON22_SOURCE_DRIVERS_EXPECTED^^}"
      if [[ "$PD_LOCAL_ON22_EXPECTED_DRIVERS_UPPER" == "AUTO" \
          || "$PD_LOCAL_ON22_EXPECTED_DRIVERS_UPPER" == "DISCOVERED" \
          || "$PD_LOCAL_ON22_EXPECTED_DRIVERS_UPPER" == "TIMING" \
          || "$PD_LOCAL_ON22_EXPECTED_DRIVERS_UPPER" == "TIMING_REPORT" ]]; then
        if [[ "$PD_LOCAL_ON22_SOURCE_DRIVERS_FOUND" =~ ^[0-9]+$ && "$PD_LOCAL_ON22_SOURCE_DRIVERS_FOUND" -gt 0 ]]; then
          echo "| PD local ON22 source drivers | \`AUTO_DISCOVERED_POSITIVE\` | \`$PD_LOCAL_ON22_SOURCE_DRIVERS_FOUND\` | PASS |"
        else
          echo "| PD local ON22 source drivers | \`AUTO_DISCOVERED_POSITIVE\` | \`$PD_LOCAL_ON22_SOURCE_DRIVERS_FOUND\` | FAIL |"
        fi
      elif [[ "$PD_LOCAL_ON22_SOURCE_DRIVERS_EXPECTED" != "NA" ]]; then
        emit_check "PD local ON22 source drivers" "$PD_LOCAL_ON22_SOURCE_DRIVERS_EXPECTED" "$PD_LOCAL_ON22_SOURCE_DRIVERS_FOUND"
      else
    ...
    echo "- PD local ON22 discovery mode: \`$PD_LOCAL_ON22_DISCOVERY_MODE\`"
    echo "- PD local ON22 timing max paths: \`$PD_LOCAL_ON22_TIMING_MAX_PATHS\`"
    echo "- PD local ON22 apply repair: \`$PD_LOCAL_ON22_APPLY_REPAIR\`"
    echo "- PD local ON22 timing rows: \`$PD_LOCAL_ON22_TIMING_ON22_ROWS_FOUND\`"
    echo "- PD local ON22 timing local rows: \`$PD_LOCAL_ON22_TIMING_ON22_LOCAL_ROWS_FOUND\`"
    echo "- PD local ON22 unique timing instances: \`$PD_LOCAL_ON22_TIMING_UNIQUE_ON22_INSTANCES_FOUND\`"
    echo "- PD local ON22 resolved timing instances: \`$PD_LOCAL_ON22_TIMING_RESOLVED_ON22_INSTANCES_FOUND\`"
    echo "- PD local ON22 unresolved cells: \`$PD_LOCAL_ON22_UNRESOLVED_CELLS\`"
    echo "- PD local ON22 source cell: \`$PD_LOCAL_ON22_SOURCE_CELL\`"
    echo "- PD local ON22 allow X2: \`$PD_LOCAL_ON22_ALLOW_X2\`"
    echo "- PD local ON22 requested targets: \`$PD_LOCAL_ON22_REQUESTED_TARGET_CELLS\`"
    echo "- PD local ON22 selected target: \`$PD_LOCAL_ON22_SELECTED_TARGET\`"
    echo "- PD local ON22 source drivers: \`$PD_LOCAL_ON22_SOURCE_DRIVERS_FOUND / $PD_LOCAL_ON22_SOURCE_DRIVERS_EXPECTED\`"
...
CHECK_REPORT="$RESULT_DIR/o13_phase_distribution_check.rpt"
{
  ...
  echo "PD_LOCAL_ON22_APPLY_REPAIR=$PD_LOCAL_ON22_APPLY_REPAIR"
  echo "PD_LOCAL_ON22_SOURCE_CELL=$PD_LOCAL_ON22_SOURCE_CELL"
  echo "PD_LOCAL_ON22_ALLOW_X2=$PD_LOCAL_ON22_ALLOW_X2"
  echo "PD_LOCAL_ON22_REQUESTED_TARGET_CELLS=$PD_LOCAL_ON22_REQUESTED_TARGET_CELLS"
  ...
  echo "PD_LOCAL_ON22_TIMING_ON22_ROWS_FOUND=$PD_LOCAL_ON22_TIMING_ON22_ROWS_FOUND"
  echo "PD_LOCAL_ON22_TIMING_ON22_LOCAL_ROWS_FOUND=$PD_LOCAL_ON22_TIMING_ON22_LOCAL_ROWS_FOUND"
  echo "PD_LOCAL_ON22_TIMING_UNIQUE_ON22_INSTANCES_FOUND=$PD_LOCAL_ON22_TIMING_UNIQUE_ON22_INSTANCES_FOUND"
  echo "PD_LOCAL_ON22_TIMING_RESOLVED_ON22_INSTANCES_FOUND=$PD_LOCAL_ON22_TIMING_RESOLVED_ON22_INSTANCES_FOUND"
  echo "PD_LOCAL_ON22_SOURCE_DRIVERS_EXPECTED=$PD_LOCAL_ON22_SOURCE_DRIVERS_EXPECTED"
  ...
  echo "PD_LOCAL_ON22_UNRESOLVED_CELLS=$PD_LOCAL_ON22_UNRESOLVED_CELLS"
  ...
  echo "PD_LOCAL_ON22_DISCOVERY_MODE=$PD_LOCAL_ON22_DISCOVERY_MODE"
  echo "PD_LOCAL_ON22_TIMING_MAX_PATHS=$PD_LOCAL_ON22_TIMING_MAX_PATHS"
...
if [[ "${MPTDC_GENUS_REPAIR_PD_LOCAL_ON22:-0}" == "1" ]]; then
  ...
  PD_LOCAL_ON22_DRIVERS_GATE_OK=NO
  ...
  if [[ "$PD_LOCAL_ON22_EXPECTED_DRIVERS_UPPER" == "AUTO" \
      ...
      || "$PD_LOCAL_ON22_EXPECTED_DRIVERS_UPPER" == "TIMING" \
      || "$PD_LOCAL_ON22_EXPECTED_DRIVERS_UPPER" == "TIMING_REPORT" ]]; then
    if [[ "$PD_LOCAL_ON22_SOURCE_DRIVERS_FOUND" =~ ^[0-9]+$ \
        && "$PD_LOCAL_ON22_ENDPOINTS_EXPECTED" =~ ^[0-9]+$ \
        && "$PD_LOCAL_ON22_SOURCE_DRIVERS_FOUND" -gt 0 \
        && "$PD_LOCAL_ON22_SOURCE_DRIVERS_FOUND" -le "$PD_LOCAL_ON22_ENDPOINTS_EXPECTED" ]]; then
      PD_LOCAL_ON22_DRIVERS_GATE_OK=YES
    fi
  elif [[ "$PD_LOCAL_ON22_SOURCE_DRIVERS_EXPECTED" =~ ^[0-9]+$ \
      && "$PD_LOCAL_ON22_SOURCE_DRIVERS_FOUND" == "$PD_LOCAL_ON22_SOURCE_DRIVERS_EXPECTED" ]]; then
    PD_LOCAL_ON22_DRIVERS_GATE_OK=YES
  elif [[ "$PD_LOCAL_ON22_SOURCE_DRIVERS_EXPECTED" == "NA" \
      && "$PD_LOCAL_ON22_SOURCE_DRIVERS_FOUND" == "$PD_LOCAL_ON22_ENDPOINTS_EXPECTED" ]]; then
    PD_LOCAL_ON22_DRIVERS_GATE_OK=YES
  fi
  PD_LOCAL_ON22_EXPECTED_CELLS_UPPER="${PD_LOCAL_ON22_SOURCE_CELLS_EXPECTED^^}"
  if [[ "$PD_LOCAL_ON22_EXPECTED_CELLS_UPPER" == "AUTO" || "$PD_LOCAL_ON22_EXPECTED_CELLS_UPPER" == "DISCOVERED" ]]; then
  ...
  if [[ ( "$PD_LOCAL_ON22_REPAIR_ENABLE" == "1" || "$PD_LOCAL_ON22_REPAIR_ENABLE" == "true" ) \
      && ( "$PD_LOCAL_ON22_APPLY_REPAIR" == "1" || "$PD_LOCAL_ON22_APPLY_REPAIR" == "true" ) \
...

{
  ...
  for file in \
    ...
    pd_local_on22_cell_repair.csv \
    pd_local_on22_legal_cells.rpt \
    pd_local_on22_timing_discovery.rpt \
