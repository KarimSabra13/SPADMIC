...
#  Created on Tue May 19 09:54:32 2026                
#                                                     
#######################################################
...
createRegion mptdc_pd_matrix 332.08 329.28 632.24 629.44
createPlaceBlockage -name mptdc_slow_osc_keepout -type hard -box 322.0 649.6 642.32 769.44
createPlaceBlockage -name mptdc_fast_osc_keepout -type hard -box 322.0 189.28 642.32 309.12
...
group_path -name in2reg_tmp.1672774 -from {0x2ba 0x2bd} -to 0x2c0 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.1672774 -from {0x2c3 0x2c6} -to 0x2c9 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.1672774 -from 0x2cb -to 0x2cc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.1672774 -from 0x2cf -to 0x2d0
setPathGroupOptions reg2reg_tmp.1672774 -effortLevel high
...
get_delay_corner $dcCorner -late_library_set
get_delay_corner $dcCorner -early_library_set
reset_path_group -name in2reg_tmp.1672774
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.1672774
set_global _is_ipo_interactive_path_groups 0
...
all_setup_analysis_views
getPlaceMode -exp_slack_driven -quiet
reset_path_group -name reg2reg_tmp.1672774
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name reg2out_tmp.1672774
set_global _is_ipo_interactive_path_groups 0
...
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2reg_tmp.1672774 -from {0x2d4 0x2d7} -to 0x2da -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.1672774 -from {0x2dd 0x2e0} -to 0x2e3 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.1672774 -from 0x2e5 -to 0x2e6
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.1672774 -from 0x2e9 -to 0x2ea
setPathGroupOptions reg2reg_tmp.1672774 -effortLevel high
reset_path_group -name in2reg_tmp.1672774
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.1672774
