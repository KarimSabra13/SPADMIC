...
- pre-calibration raw tuple/code-density evidence from the fixed feature packet,
- post-calibration reconstructed timestamp evidence generated by the host/scripts.
