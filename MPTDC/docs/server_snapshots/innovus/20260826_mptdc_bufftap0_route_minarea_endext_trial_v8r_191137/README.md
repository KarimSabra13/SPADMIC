...
- Kind: `innovus`
- Run ID: `20260826_mptdc_bufftap0_route_minarea_endext_trial_v8r_191137`
- Source directory: `/sim/ksabra/SPADMIC_work/innovus/20260826_mptdc_bufftap0_route_minarea_endext_trial_v8r_191137`
- Snapshot directory: `/home/validmgr/ksabra/2026_SPAD/SPADMIC/MPTDC/docs/server_snapshots/innovus/20260826_mptdc_bufftap0_route_minarea_endext_trial_v8r_191137`
- Collection branch: `SPADMIC_test`
- Collection commit: `2e18524daac4c69ad3b8e04515b18c785e0e95a1`
- Created UTC: `2026-08-26T17:12:43Z`

## Included Files
- `README.md`
- `logs/checkpoint_repair_wrapper.log.messages.tail`
- `logs/innovus_route_checkpoint_repair.log.messages.tail`
- `logs/route_minarea_endext_v8_driver.log.messages.tail`
- `manifests/route_minarea_endext_v8_commands.rpt`
...
- `reports/01_command_mptdc_ckpt_manual_single_minarea_endext_trial_v8.rpt`
- `reports/checkpoint_repair_status.rpt`
- `reports/min_area_fixed_wire_endext_trial_v8.rpt`
- `reports/minarea_v8_trial_pre_report_route.rpt`
- `reports/minarea_v8_trial_pre_verify_connectivity_regular.rpt`
- `reports/minarea_v8_trial_pre_verify_connectivity_special.rpt`
- `reports/minarea_v8_trial_pre_verify_connectivity_special_command.rpt`
- `reports/minarea_v8_trial_pre_verify_connectivity_special_detailed.console.rpt`
- `reports/minarea_v8_trial_pre_verify_connectivity_special_detailed.rpt`
- `reports/minarea_v8_trial_pre_verify_drc.rpt`
- `reports/minarea_v8_trial_pre_verify_drc_markers.tsv`
- `reports/minarea_v8_trial_pre_verify_drc_markers_schema.rpt`
- `reports/operator_gate_route_min_area_endext_trial.rpt`
