...
South side carries async reset when present and the two buffered RO tap0 observability pins. VDD/VSS are special power nets handled by the power-grid plan, not ordinary signal IO ports.
