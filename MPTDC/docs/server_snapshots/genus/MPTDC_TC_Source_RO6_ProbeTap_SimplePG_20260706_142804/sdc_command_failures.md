...
- Genus log: `genus_MPTDC_TC_Source_RO6_ProbeTap_SimplePG_20260706_142804.log`

SDC_COMMAND_FAILURE_COUNT=0
ACTIVE_SDC_FAILURE_COUNT=0
REPORT_DIAGNOSTIC_WARNING_COUNT=2
RAW_SDC_DIAGNOSTIC_COUNT=0
SDC_235_COUNT=0
TUI_61_COUNT=0
SDC_INVALID_OBJECT_COUNT=0
GENERIC_SDC_202_209_COUNT=2
GENERIC_SDC_202_209_ACTIVE_COUNT=0
...
- Generic SDC-202/SDC-209 banners are active only when paired with a failed SDC command, raw object/constraint diagnostic, or MPTDC fatal/error.
