...
#  Created by Genus(TM) Synthesis Solution 22.13-s093_1 on Mon Jul 06 11:52:34 CEST 2026
...
current_design mptdc_axis_core
...
set_load -pin_load 0.01 [get_ports pkt_valid_o]
set_load -pin_load 0.01 [get_ports {pkt_data_o[15]}]
set_load -pin_load 0.01 [get_ports {pkt_data_o[14]}]
set_load -pin_load 0.01 [get_ports {pkt_data_o[13]}]
set_load -pin_load 0.01 [get_ports {pkt_data_o[12]}]
set_load -pin_load 0.01 [get_ports {pkt_data_o[11]}]
set_load -pin_load 0.01 [get_ports {pkt_data_o[10]}]
set_load -pin_load 0.01 [get_ports {pkt_data_o[9]}]
set_load -pin_load 0.01 [get_ports {pkt_data_o[8]}]
set_load -pin_load 0.01 [get_ports {pkt_data_o[7]}]
set_load -pin_load 0.01 [get_ports {pkt_data_o[6]}]
set_load -pin_load 0.01 [get_ports {pkt_data_o[5]}]
set_load -pin_load 0.01 [get_ports {pkt_data_o[4]}]
set_load -pin_load 0.01 [get_ports {pkt_data_o[3]}]
set_load -pin_load 0.01 [get_ports {pkt_data_o[2]}]
set_load -pin_load 0.01 [get_ports {pkt_data_o[1]}]
set_load -pin_load 0.01 [get_ports {pkt_data_o[0]}]
set_load -pin_load 0.01 [get_ports pkt_sop_o]
set_load -pin_load 0.01 [get_ports pkt_eop_o]
set_load -pin_load 0.01 [get_ports packet_active_o]
set_load -pin_load 0.01 [get_ports packet_pending_o]
set_load -pin_load 0.01 [get_ports ro_slow_tap0_o]
set_load -pin_load 0.01 [get_ports ro_fast_tap0_o]
set_load -pin_load 0.01 [get_ports ready_o]
set_load -pin_load 0.01 [get_ports busy_o]
...
set_false_path -to [list \
  ...
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[6].u_pd/clear_window}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[7].u_pd/clear_window}]  \
  [get_ports ro_fast_tap0_o]  \
  [get_ports ro_slow_tap0_o]  \
  [get_pins u_core_start_timeout_latched_reg/RN]  \
  [get_pins {u_core_start_wdt_cnt_reg[0]/RN}]  \
  [get_pins {u_core_start_wdt_cnt_reg[1]/RN}]  \
  [get_pins {u_core_start_wdt_cnt_reg[2]/RN}]  \
  ...
  [get_pins {u_core_u_stop_capture_stop_slow_phase_disc_o_reg[1]/D}]  \
  [get_pins {u_core_u_stop_capture_stop_slow_phase_disc_o_reg[2]/D}] ]
set_false_path -from [get_pins {u_core_u_phase_buf_slow/gen_phase_buf[0].u_drv/Q}] -to [list \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[6].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[4].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[3].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[5].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[7].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[1].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[0].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[2].u_pd/q1_reg/D}] ]
set_false_path -from [get_pins {u_core_u_phase_buf_slow/gen_phase_buf[1].u_drv/Q}] -to [list \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[7].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[1].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[0].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[6].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[3].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[5].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[4].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[2].u_pd/q1_reg/D}] ]
set_false_path -from [get_pins {u_core_u_phase_buf_slow/gen_phase_buf[2].u_drv/Q}] -to [list \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[6].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[4].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[3].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[5].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[1].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[7].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[0].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[2].u_pd/q1_reg/D}] ]
set_false_path -from [get_pins {u_core_u_phase_buf_slow/gen_phase_buf[3].u_drv/Q}] -to [list \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[6].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[4].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[3].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[5].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[1].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[7].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[0].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[2].u_pd/q1_reg/D}] ]
set_false_path -from [get_pins {u_core_u_phase_buf_slow/gen_phase_buf[4].u_drv/Q}] -to [list \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[5].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[4].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[1].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[0].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[3].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[7].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[6].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[2].u_pd/q1_reg/D}] ]
set_false_path -from [get_pins {u_core_u_phase_buf_slow/gen_phase_buf[5].u_drv/Q}] -to [list \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[4].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[0].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[1].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[5].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[3].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[6].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[7].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[2].u_pd/q1_reg/D}] ]
set_false_path -from [get_pins {u_core_u_phase_buf_slow/gen_phase_buf[6].u_drv/Q}] -to [list \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[4].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[0].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[5].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[1].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[3].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[7].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[6].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[2].u_pd/q1_reg/D}] ]
set_false_path -from [get_pins {u_core_u_phase_buf_slow/gen_phase_buf[7].u_drv/Q}] -to [list \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[7].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[1].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[0].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[6].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[3].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[5].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[4].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[2].u_pd/q1_reg/D}] ]
set_false_path -from [get_pins {u_core_u_phase_buf_slow/gen_phase_buf[0].u_drv/Q}] -to [list \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[0].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[1].u_pd/q1_reg/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[2].u_pd/q1_reg/D}]  \
...
set_max_delay 6.25 -from [list \
  ...
  [get_pins {u_core_u_hit_capture_bridge_snapshot_q_reg[row_nonzero][0]/D}]  \
  [get_pins {u_core_u_hit_capture_bridge_snapshot_q_reg[row_nonzero][1]/D}]  \
  [get_pins {u_core_u_hit_capture_bridge_snapshot_q_reg[row_nonzero][2]/D}]  \
  [get_pins {u_core_u_hit_capture_bridge_snapshot_q_reg[row_nonzero][3]/D}]  \
  [get_pins {u_core_u_hit_capture_bridge_snapshot_q_reg[row_nonzero][4]/D}]  \
  [get_pins {u_core_u_hit_capture_bridge_snapshot_q_reg[row_nonzero][5]/D}]  \
  [get_pins {u_core_u_hit_capture_bridge_snapshot_q_reg[row_nonzero][6]/D}]  \
  [get_pins {u_core_u_hit_capture_bridge_snapshot_q_reg[row_nonzero][7]/D}]  \
...
set_max_delay 1.333 -from [list \
  [get_pins {u_core_gen_fast_tag_col[0].u_fast_tag_tag_o_reg[5]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[0].u_fast_tag_tag_o_reg[6]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[1].u_fast_tag_tag_o_reg[5]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[1].u_fast_tag_tag_o_reg[6]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[2].u_fast_tag_tag_o_reg[5]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[2].u_fast_tag_tag_o_reg[6]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[3].u_fast_tag_tag_o_reg[5]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[3].u_fast_tag_tag_o_reg[6]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[4].u_fast_tag_tag_o_reg[5]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[4].u_fast_tag_tag_o_reg[6]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[5].u_fast_tag_tag_o_reg[5]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[5].u_fast_tag_tag_o_reg[6]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[6].u_fast_tag_tag_o_reg[5]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[6].u_fast_tag_tag_o_reg[6]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[7].u_fast_tag_tag_o_reg[5]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[7].u_fast_tag_tag_o_reg[6]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[0].u_fast_tag_tag_o_reg[0]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[1].u_fast_tag_tag_o_reg[0]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[2].u_fast_tag_tag_o_reg[0]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[3].u_fast_tag_tag_o_reg[0]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[4].u_fast_tag_tag_o_reg[0]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[5].u_fast_tag_tag_o_reg[0]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[6].u_fast_tag_tag_o_reg[0]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[7].u_fast_tag_tag_o_reg[0]/C}] ] -to [list \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[0].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[1].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[2].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[2].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[3].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[4].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[4].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[4].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[5].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[6].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[6].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[6].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[7].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[1].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[1].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[1].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[2].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[2].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[3].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[4].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[5].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[7].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[7].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[7].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[0].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[1].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[2].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[2].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[3].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[4].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[4].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[4].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[5].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[6].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[6].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[6].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[7].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[0].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[1].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[2].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[2].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[3].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[4].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[4].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[4].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[5].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[6].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[6].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[6].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[7].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[0].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[0].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[0].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[1].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[1].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[1].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[2].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[2].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[3].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[4].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[4].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[4].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[5].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[5].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[5].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[6].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[7].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[0].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[0].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[0].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[2].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[2].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[3].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[4].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[4].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[4].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[6].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[7].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[0].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[0].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[0].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[2].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[2].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[3].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[4].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[4].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[4].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[6].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[7].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[1].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[1].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[1].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[2].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[2].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[3].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[4].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[5].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[7].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[7].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[7].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[0].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[0].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[0].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[6].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[6].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[6].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[0].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[0].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[0].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[6].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[6].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[6].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[1].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[1].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[1].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[5].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[5].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[5].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[5].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[5].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[5].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[1].u_pd/nfast_hit_latched_reg[6]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[1].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[1].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[3].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[3].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[3].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[3].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[3].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[3].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[3].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[3].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[5].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[5].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[5].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[5].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[5].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[5].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[5].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[5].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[5].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[5].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[7].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[7].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[1].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[1].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[7].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[7].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[7].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[7].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[6].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[6].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[1].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[1].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[4].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[4].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[7].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[7].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[6].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[6].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[1].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[1].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[4].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[4].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[6].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[6].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[7].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[7].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[7].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[7].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[0].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[0].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[0].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[0].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[0].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[0].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[2].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[2].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[2].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[2].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[2].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[2].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[2].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[2].u_pd/nfast_hit_latched_reg[5]/D}]  \
  [get_pins {u_core_gen_pd_row[2].gen_pd_col[3].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[3].gen_pd_col[3].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[0].gen_pd_col[3].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[4].gen_pd_col[3].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[1].gen_pd_col[3].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[5].gen_pd_col[3].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[6].gen_pd_col[3].u_pd/nfast_hit_latched_reg[0]/D}]  \
  [get_pins {u_core_gen_pd_row[7].gen_pd_col[3].u_pd/nfast_hit_latched_reg[0]/D}] ]
...
group_path -weight 8.000000 -name FAST_TAG_TO_PD_TS_EXACT_B056 -from [list \
  [get_pins {u_core_gen_fast_tag_col[0].u_fast_tag_tag_o_reg[5]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[0].u_fast_tag_tag_o_reg[6]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[1].u_fast_tag_tag_o_reg[5]/C}]  \
  [get_pins {u_core_gen_fast_tag_col[1].u_fast_tag_tag_o_reg[6]/C}]  \
...
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {input_sel_i[0]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports conv_arm_i]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports fifo_clr_i]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports soft_reset_i]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {max_hits_i[3]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {max_hits_i[2]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {max_hits_i[1]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {max_hits_i[0]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {ro_slow_code_i[7]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {ro_slow_code_i[6]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {ro_slow_code_i[5]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {ro_slow_code_i[4]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {ro_slow_code_i[3]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {ro_slow_code_i[2]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {ro_slow_code_i[1]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {ro_slow_code_i[0]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {ro_fast_code_i[7]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {ro_fast_code_i[6]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {ro_fast_code_i[5]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {ro_fast_code_i[4]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {ro_fast_code_i[3]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {ro_fast_code_i[2]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {ro_fast_code_i[1]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {ro_fast_code_i[0]}]
set_input_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports pkt_ready_i]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports pkt_valid_o]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {pkt_data_o[15]}]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {pkt_data_o[14]}]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {pkt_data_o[13]}]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {pkt_data_o[12]}]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {pkt_data_o[11]}]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {pkt_data_o[10]}]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {pkt_data_o[9]}]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {pkt_data_o[8]}]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {pkt_data_o[7]}]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {pkt_data_o[6]}]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {pkt_data_o[5]}]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {pkt_data_o[4]}]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {pkt_data_o[3]}]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {pkt_data_o[2]}]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {pkt_data_o[1]}]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports {pkt_data_o[0]}]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports pkt_sop_o]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports pkt_eop_o]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports packet_active_o]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports packet_pending_o]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports ro_slow_tap0_o]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports ro_fast_tap0_o]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports ready_o]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports busy_o]
set_output_delay -clock [get_clocks clk_sys] -add_delay 0.5 [get_ports fifo_full_o]
set_max_fanout 20.000 [current_design]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[0].u_fast_tag_tag_o_reg[5]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[0].u_fast_tag_tag_o_reg[6]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[1].u_fast_tag_tag_o_reg[5]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[1].u_fast_tag_tag_o_reg[6]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[2].u_fast_tag_tag_o_reg[5]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[2].u_fast_tag_tag_o_reg[6]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[3].u_fast_tag_tag_o_reg[5]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[3].u_fast_tag_tag_o_reg[6]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[4].u_fast_tag_tag_o_reg[5]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[4].u_fast_tag_tag_o_reg[6]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[5].u_fast_tag_tag_o_reg[5]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[5].u_fast_tag_tag_o_reg[6]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[6].u_fast_tag_tag_o_reg[5]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[6].u_fast_tag_tag_o_reg[6]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[7].u_fast_tag_tag_o_reg[5]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[7].u_fast_tag_tag_o_reg[6]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[0].u_fast_tag_tag_o_reg[0]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[1].u_fast_tag_tag_o_reg[0]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[2].u_fast_tag_tag_o_reg[0]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[3].u_fast_tag_tag_o_reg[0]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[4].u_fast_tag_tag_o_reg[0]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[5].u_fast_tag_tag_o_reg[0]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[6].u_fast_tag_tag_o_reg[0]/Q}]
set_max_transition 0.5 [get_pins {u_core_gen_fast_tag_col[7].u_fast_tag_tag_o_reg[0]/Q}]
...
set_input_transition 0.1 [get_ports {input_sel_i[0]}]
set_input_transition 0.1 [get_ports conv_arm_i]
set_input_transition 0.1 [get_ports fifo_clr_i]
set_input_transition 0.1 [get_ports soft_reset_i]
set_input_transition 0.1 [get_ports {max_hits_i[3]}]
set_input_transition 0.1 [get_ports {max_hits_i[2]}]
set_input_transition 0.1 [get_ports {max_hits_i[1]}]
set_input_transition 0.1 [get_ports {max_hits_i[0]}]
set_input_transition 0.1 [get_ports {ro_slow_code_i[7]}]
set_input_transition 0.1 [get_ports {ro_slow_code_i[6]}]
set_input_transition 0.1 [get_ports {ro_slow_code_i[5]}]
set_input_transition 0.1 [get_ports {ro_slow_code_i[4]}]
set_input_transition 0.1 [get_ports {ro_slow_code_i[3]}]
set_input_transition 0.1 [get_ports {ro_slow_code_i[2]}]
set_input_transition 0.1 [get_ports {ro_slow_code_i[1]}]
set_input_transition 0.1 [get_ports {ro_slow_code_i[0]}]
set_input_transition 0.1 [get_ports {ro_fast_code_i[7]}]
set_input_transition 0.1 [get_ports {ro_fast_code_i[6]}]
set_input_transition 0.1 [get_ports {ro_fast_code_i[5]}]
set_input_transition 0.1 [get_ports {ro_fast_code_i[4]}]
set_input_transition 0.1 [get_ports {ro_fast_code_i[3]}]
set_input_transition 0.1 [get_ports {ro_fast_code_i[2]}]
set_input_transition 0.1 [get_ports {ro_fast_code_i[1]}]
set_input_transition 0.1 [get_ports {ro_fast_code_i[0]}]
set_input_transition 0.1 [get_ports pkt_ready_i]
...
set_dont_use false [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/DFRJIHDX2]
set_dont_use false [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/DFRJIHDX4]
set_dont_use false [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/DFRRQJIHDX2]
set_dont_use false [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/DFRRQJIHDX4]
set_dont_use false [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/DFRSJIHDX2]
set_dont_use false [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/ON22JIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFQJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFQJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFQJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFQJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRQJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRQJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRQJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRQJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRSJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRSJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRSJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRSJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRSQJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRSQJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRSQJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRSQJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFSJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFSJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFSJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFSJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFSQJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFSQJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFSQJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFSQJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFR2JIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFR2JIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFR4JIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFR4JIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFR8JIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFR8JIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRJIHDX1]
set_dont_use false [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRJIHDX2]
set_dont_use false [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRQ2JIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRQ2JIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRQ4JIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRQ4JIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRQ8JIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRQ8JIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRQJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRQJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRQJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRQJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRR2JIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRR2JIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRR4JIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRR4JIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRR8JIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRR8JIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRQ2JIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRQ2JIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRQ4JIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRQ4JIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRQ8JIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRQ8JIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRQJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRQJIHDX1]
set_dont_use false [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRQJIHDX2]
set_dont_use false [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRQJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRSJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRSJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRSJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRSJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRSQJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRSQJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRSQJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRSQJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRSJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRSJIHDX1]
set_dont_use false [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRSJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRSJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRSQJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRSQJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRSQJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRSQJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFQSSJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFQSSJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFQSSJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFQSSJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRQSSJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRQSSJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRQSSJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFRQSSJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFSQSSJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFSQSSJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFSQSSJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFFSQSSJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRQSSJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRQSSJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRQSSJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRQSSJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRQSSJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRQSSJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRQSSJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRRQSSJIHDX4]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRSQSSJIHDX0]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRSQSSJIHDX1]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRSQSSJIHDX2]
set_dont_use true [get_lib_cells D_CELLS_JIHD_LPMOS_typ_1_80V_25C/SDFRSQSSJIHDX4]
