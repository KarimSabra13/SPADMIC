...
tracked_tie1_minarea_replay_gate_passes() {
  ...
  tracked_report_passes "$report" \
    ...
    PRE_DRC_MARKER_UNMAPPED_COUNT 0 FIXED_WIRE_TAIL_STATUS PASS \
    FIXED_WIRE_TAIL_EFFECT_STATUS PASS TARGET_WIRE_COUNT_DELTA 1 \
    ...
    N57556_LANDING_REPRESENTATION_STATUS UNCHANGED \
    TARGET_VIA_FINGERPRINT_STATUS UNCHANGED POST_MINAREA_MARKER_COUNT 0 \
    FREE_END_TAIL_LENGTH_UM 0.25 INITIAL_DRC 1 FINAL_DRC 0 \
  ...
  tracked_report_passes "$source_trial_gate" \
    ...
    COMMAND_1_STATUS PASS MANUAL_ECO_STATUS PASS REPAIR_REVISION V11 \
    MANUAL_ECO_MODE CANONICAL_FIXED_MET1_FREE_END_PERPENDICULAR_TAIL_V11 \
    ATTRIBUTE_EDIT_POLICY NO_DB_ATTRIBUTE_EDITS \
    GEOMETRY_EDIT_POLICY ONE_EXACT_TARGET_NET_REGULAR_FIXED_MET1_PERPENDICULAR_TAIL \
    ROUTE_OPTIMIZER_POLICY NO_ECOROUTE_NO_ROUTEDESIGN_NO_GLOBAL_OPTIMIZER \
    ...
    FIXED_WIRE_TAIL_STATUS PASS FIXED_WIRE_TAIL_EFFECT_STATUS PASS \
