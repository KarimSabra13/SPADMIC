...
tracked_tie1_minarea_replay_gate_passes() {
  ...
  tracked_report_passes "$report" \
    ...
    REPAIR_REVISION V9 PRE_DRC_MARKER_RECONCILIATION_STATUS PASS \
    PRE_DRC_MARKER_FRESH_DRC_TOTAL 1 PRE_DRC_MARKER_GEOMETRY_COUNT 2 \
    PRE_DRC_MARKER_LIVE_COUNT 1 PRE_DRC_MARKER_STALE_COUNT 1 \
    PRE_DRC_MARKER_UNMAPPED_COUNT 0 FIXED_WIRE_EXTENSION_STATUS PASS \
    FIXED_WIRE_EXTENSION_EFFECT_STATUS PASS POST_MINAREA_MARKER_COUNT 0 \
  ...
  tracked_report_passes "$source_trial_gate" \
    ...
    COMMAND_1_STATUS PASS MANUAL_ECO_STATUS PASS REPAIR_REVISION V9 \
    ...
    FIXED_WIRE_EXTENSION_STATUS PASS FIXED_WIRE_EXTENSION_EFFECT_STATUS PASS \
    POST_MINAREA_MARKER_COUNT 0 FREE_END_EXTENSION_DELTA_UM 0.14 \
